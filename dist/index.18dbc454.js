...
var _mapsDefault = parcelHelpers.interopDefault(_maps);
(0, _diagramDefault.default)();
...
},{"./maps":"iJleO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./diagram":"7ophb"}],"iJleO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
async function getData() {
    try {
        ...
        const topSixCourses = data.sort((a, b)=>b.applicantsTotal - a.applicantsTotal).slice(0, 6);
        const topCourses = data.sort((a, b)=>b.applicantsTotal - a.applicantsTotal);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["j2YDk","1SICI"], "1SICI", "parcelRequire2a03")
